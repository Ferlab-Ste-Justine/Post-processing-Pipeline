...
- `labels`: A string specifying the labels for the resource. This includes information about whether the resource is known, used for training, considered truth, and its prior probability.
