...
| `upd`            | Affected proband hom-alt; **exactly one parent is hom-ref** (the other carries the allele). Diagnostic of uniparental disomy / parental deletion in trans / somatic mosaicism.                                                                                                                                                                 | Trio only — needs both parents to detect the Mendelian violation                                                                                                                |
...
| ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Trio (mom + dad + affected proband) | All of: `denovo`, `recessive`, `dominant`, `x_denovo`, `x_recessive`, `x_dominant`, `upd`, `slivar_comphet`. No `candidate` — segregation is provable.                                                                                                                   |
...
- A single-variant `upd` match is **suggestive but not diagnostic** — true UPD shows up as a _cluster_ of these patterns across a chromosome. Cluster-level confirmation is a downstream task.
